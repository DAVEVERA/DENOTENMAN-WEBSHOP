...
function EditorialWorkspace({ product, proposal, busy, requestStatus, generateProposal, beginRequest, finishRequest, failRequest, setProposal, setMessage, setRetry }: {
  ...
  function requestNewProposal() {
    ...
    if (hasUnsavedWork && typeof window !== "undefined" && !window.confirm("Dit vervangt het huidige voorstel. Niet-opgeslagen keuzes en bewerkingen gaan verloren. Doorgaan?")) {
      return;
    }
