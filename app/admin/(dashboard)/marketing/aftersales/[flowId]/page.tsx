...
import { parseAftersalesContent, AFTERSALES_TRIGGERS_BY_FLOW_TYPE } from "@/lib/aftersales/schema";
import {
...
export default async function AftersalesFlowPage({ params }: { params: Promise<{ flowId: string }> }) {
