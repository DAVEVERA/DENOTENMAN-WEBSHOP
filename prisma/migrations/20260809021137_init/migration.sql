-- CreateEnum
CREATE TYPE "Locale" AS ENUM ('nl', 'en', 'fr');

-- CreateEnum
CREATE TYPE "CategoryType" AS ENUM ('STANDARD', 'PROMOTIONAL');

-- CreateEnum
CREATE TYPE "Preparation" AS ENUM ('RAW', 'ROASTED');

-- CreateEnum
CREATE TYPE "Salting" AS ENUM ('UNSALTED', 'SALTED');

-- CreateEnum
CREATE TYPE "Coating" AS ENUM ('NONE', 'CHOCOLATE', 'YOGHURT', 'FLAVORED');
...
-- CreateEnum
CREATE TYPE "CompositionSource" AS ENUM ('TEXT', 'VOICE');
...
CREATE TABLE "ProductVariant" (
    ...
    "preparation" "Preparation" NOT NULL,
    "salting" "Salting" NOT NULL,
    "coating" "Coating" NOT NULL DEFAULT 'NONE',
    "isActive" BOOLEAN NOT NULL DEFAULT true,
...
-- AddForeignKey
ALTER TABLE "VariantTranslation" ADD CONSTRAINT "VariantTranslation_variantId_fkey" FOREIGN KEY ("variantId") REFERENCES "ProductVariant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
