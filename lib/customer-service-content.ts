...
export function getCustomerServiceCopy(locale: Locale): CustomerServiceCopy {
  ...
  if (locale === "en") {
    return {
      ...
      entries: [
        ...
        { id: "market-days", category: "Markets", question: "Where can I find De Notenman at the market?", answer: "Thursday in Hilvarenbeek from 08:00–12:00, Friday in Uden from 08:00–12:30 and Saturday in Antwerp from 08:00–16:00.", links: [{ label: "Where is De Notenman?", href: marketsHref }] },
      ],
      marketsEyebrow: "Market route",
      marketsTitle: "Visit De Notenman",
      marketsLead: "These are our fixed market days and times.",
      marketsLinkLabel: "View Where is De Notenman",
  ...
  if (locale === "fr") {
    return {
      ...
      entries: [
        ...
        { id: "market-days", category: "Marchés", question: "Où retrouver De Notenman au marché ?", answer: "Jeudi à Hilvarenbeek de 08:00 à 12:00, vendredi à Uden de 08:00 à 12:30 et samedi à Anvers de 08:00 à 16:00.", links: [{ label: "Où est De Notenman ?", href: marketsHref }] },
      ],
      ...
      marketsLinkLabel: "Voir Où est De Notenman",
      contactEyebrow: "Contact",
  ...
  return {
    ...
    entries: [
      ...
      { id: "market-days", category: "Markten", question: "Waar staat De Notenman op de markt?", answer: "Donderdag in Hilvarenbeek van 08:00–12:00, vrijdag in Uden van 08:00–12:30 en zaterdag in Antwerpen van 08:00–16:00.", links: [{ label: "Waar is De Notenman?", href: marketsHref }] },
    ],
    marketsEyebrow: "Marktroute",
    marketsTitle: "Bezoek De Notenman",
    marketsLead: "Dit zijn onze vaste marktdagen en tijden.",
    marketsLinkLabel: "Bekijk Waar is De Notenman",
    contactEyebrow: "Contact",
